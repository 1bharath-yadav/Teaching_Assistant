...
print(
    client.collections["books"].documents.search(
        {"q": "hunger", "query_by": "title", "sort_by": "ratings_count:desc"}
    )
)
...
import_results = client.collections["books"].documents.import_(
    docs_to_import, {"action": "upsert", "return_id": True}
)
print(import_results)
...
print(
    client.collections["books"].documents.update(
...
print(
    client.collections["books"].documents.delete(
